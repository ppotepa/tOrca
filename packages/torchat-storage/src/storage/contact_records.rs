use torchat_runtime::VerificationState;
...
mod tests {
    ...
    fn maps_verification_states_to_sql_names() {
        assert_eq!(
            verification_state_sql(torchat_runtime::VerificationState::Verified),
            "VERIFIED"
        );
        assert_eq!(
            verification_state_sql(torchat_runtime::VerificationState::Unverified),
            "UNVERIFIED"
        );
    }
}
