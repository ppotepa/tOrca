...
import 'package:torchat_mobile/app/conversation_navigation_intent.dart';
...
final class DesktopNotificationAdapter implements NotificationService {
  ...
  Future<void> clear(String notificationId) =>
      DesktopNotificationService.clear(notificationId);
}
