...
val selectedConfigFile = System.getenv("TORCHAT_CONFIG_FILE")?.takeIf { it.isNotBlank() }
    ...
    ?: error("TorChat environment is missing. Run .\\scripts\\torchat.ps1 stack start")
...
android {
    ...
    defaultConfig {
        ...
        require(Regex("^https?://[a-z2-7]{56}\\.onion$").matches(canonicalOnionUrl)) {
            "Missing or invalid TORCHAT_ONION_URL in $selectedConfigFile. Run .\\scripts\\torchat.ps1 stack start"
        }
