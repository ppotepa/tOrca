...
void main() {
  test('verifies a signed manifest and selects the platform artifact', () async {
  ...
  test('rejects payload tampering and a foreign key id', () async {
    final fixture = await _signedFixture();
    final envelope = jsonDecode(utf8.decode(fixture.envelope)) as Map<String, dynamic>;
  ...
  test('orders prerelease identifiers before release versions', () {
    expect(
      TorcaVersion.parse('0.2.0-beta.2')
    ...
    expect(
      TorcaVersion.parse('0.2.0-beta.10')
...
Future<_SignedFixture> _signedFixture() async {
  ...
  final envelope = utf8.encode(jsonEncode(<String, Object>{
    'schema': 1,
    'algorithm': 'ed25519',
