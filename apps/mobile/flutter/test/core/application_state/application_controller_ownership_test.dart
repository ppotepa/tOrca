...
void main() {
  test(
    'application state has one notifier and no controller inheritance chain',
    () {
      ...
      expect(
        provider,
        contains('NotifierProvider<ApplicationController, AppState>'),
      );
      ...
      expect(
        controller,
        contains('class ApplicationController extends Notifier<AppState>'),
      );
