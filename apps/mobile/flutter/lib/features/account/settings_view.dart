...
class _SettingsViewState extends ConsumerState<SettingsView> {
  ...
  Future<void> _loadPreferences() async {
    ...
    if (Platform.isWindows) {
      try {
        autostart = await PlatformServices.current.autostart.isEnabled();
      } catch (_) {
        autostart = false;
      }
    }
  ...
  Future<void> _setAutostart(bool value) async {
    ...
    try {
      await PlatformServices.current.autostart.setEnabled(value);
      final actual = await PlatformServices.current.autostart.isEnabled();
