...
import 'package:torchat_flutter_ui/core/presentation/desktop_workspace_shell.dart';
...
class _DesktopWorkspaceState extends State<DesktopWorkspace> {
  ...
  Widget build(BuildContext context) {
    ...
    return DesktopWorkspaceShell(
      ...
      inspectorToggleTooltip: selected == null
          ? context.l10n.uiShowDetails
          : (_inspectorOpen
                ? context.l10n.uiHideDetails
                : context.l10n.uiShowDetails),
      rail: (context, compact, toggle) => _CompactNavigationRail(
        compact: compact,
        tab: widget.tab,
