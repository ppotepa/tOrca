...
class AndroidRelayTransport(
    ...
    suspend fun searchDirectory(query: String): List<DirectoryEntry> {
        val encoded = URLEncoder.encode(query, Charsets.UTF_8.name())
        val json = authorizedRequest("$baseUrl/v1/directory/search?q=$encoded", "GET")
        ...
        return (0 until array.length()).map { index ->
            ...
            DirectoryEntry(
                ...
                publicKey = item.getString("public_key"),
